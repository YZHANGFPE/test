...
class track():
            ...
            if self.found == 1:
                ...
                if id == 3 or id == 4:
                    if close != -1 :
                        ...
                        ik_move(hdr,arm, target_dx = 0.085,speedx = 0.2, timeout = 4)
                    ...
                    if z > threshold_z[id-1]:
                        ...
                        solution_found, predict_pose = ik_move_one_step(initial_pose, predict_pose, hdr, arm, self.kin_right, target_dx = vx, target_dy = vy)
    ...
    def pour_tomato(self):
        ...
        ik_move_to_pose(self.control_arm,self.kin_right,pour_pose)
        pour_pose.pose.orientation.x = pour_tomato_45q[0]
        pour_pose.pose.orientation.y = pour_tomato_45q[1]
        pour_pose.pose.orientation.z = pour_tomato_45q[2]
        pour_pose.pose.orientation.w = pour_tomato_45q[3]
...
def main():
    ...
    set_joints(target_angles_right = joint_states['observe'],timeout= 100000)
    tracker=track()
