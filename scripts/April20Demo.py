            ...
            if self.found == 1:
                ...
                if id == 3:
                    if close != -1 :
                        ...
                        ik_move(hdr,arm, target_dx = 0.08,speed = 0.2)
...
def main():
    ...
    #speak("Hi. I am Julia, your personal chef.")
    # speak("Can I make you a salad?")
    # rospy.sleep(3)
    #pour tomato
    # set_joints(target_angles_right = joint_states['observe'])
    # initial_pose = get_current_pose(hdr,arm)
    # speak("I am looking for the tomato")
